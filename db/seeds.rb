...
Property.create!([{ name: 'Art Deco delight in a coveted locale', description: 'Infused with Art Deco charm, a peaceful lifestyle awaits in this beautifully presented solid brick, period style sanctuary with a wide street frontage, ideally located in a prime Caulfield North locale.', property_type: PropertyType.last,
                    owner: User.last, address: Address.all[2], bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, price: 50, property_image: { io: File.open(Rails.root.join('app/assets/images/c3.jpg')), filename: 'c3.jpg' } }])
Property.create!([{ name: 'Loved place', description: 'Presenting opulent, resort-style living in a highly desired location, this astonishing residence is sure to take your breath away.', property_type: PropertyType.last,
                    owner: User.last, address: Address.all[3], bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, price: 50, property_image: { io: File.open(Rails.root.join('app/assets/images/c4.jpg')), filename: 'c4.jpg' } }])
Property.create!([{ name: 'Loved place', description: 'Presenting opulent, resort-style living in a highly desired location, this astonishing residence is sure to take your breath away.', property_type: PropertyType.last,
                    owner: User.last, address: Address.all[4], bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, price: 50, property_image: { io: File.open(Rails.root.join('app/assets/images/c5.jpg')), filename: 'c5.jpg' } }])
Property.create!([{ name: 'Loved place', description: 'Presenting opulent, resort-style living in a highly desired location, this astonishing residence is sure to take your breath away.', property_type: PropertyType.last,
                    owner: User.last, address: Address.all[5], bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, price: 50, property_image: { io: File.open(Rails.root.join('app/assets/images/c6.jpg')), filename: 'c6.jpg' } }])
Property.create!([{ name: 'Loved place', description: 'Presenting opulent, resort-style living in a highly desired location, this astonishing residence is sure to take your breath away.', property_type: PropertyType.last,
                    owner: User.last, address: Address.all[6], bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, price: 50, property_image: { io: File.open(Rails.root.join('app/assets/images/c7.jpg')), filename: 'c7.jpg' } }])
Property.create!([{ name: 'Loved place', description: 'Presenting opulent, resort-style living in a highly desired location, this astonishing residence is sure to take your breath away.', property_type: PropertyType.last,
                    owner: User.last, address: Address.all[7], bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, price: 50, property_image: { io: File.open(Rails.root.join('app/assets/images/c8.jpg')), filename: 'c8.jpg' } }])
Property.create!([{ name: 'Loved place', description: 'Presenting opulent, resort-style living in a highly desired location, this astonishing residence is sure to take your breath away.', property_type: PropertyType.last,
                    owner: User.last, address: Address.all[8], bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, price: 50, property_image: { io: File.open(Rails.root.join('app/assets/images/c9.jpg')), filename: 'c9.jpg' } }])
Property.create!([{ name: 'Loved place', description: 'Presenting opulent, resort-style living in a highly desired location, this astonishing residence is sure to take your breath away.', property_type: PropertyType.last,
                    owner: User.last, address: Address.all[9], bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, price: 50, property_image: { io: File.open(Rails.root.join('app/assets/images/c10.jpg')), filename: 'c10.jpg' } }])
Property.create!([{ name: 'Loved place', description: 'Presenting opulent, resort-style living in a highly desired location, this astonishing residence is sure to take your breath away.', property_type: PropertyType.last,
                    owner: User.last, address: Address.all[10], bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, price: 50, property_image: { io: File.open(Rails.root.join('app/assets/images/c11.jpg')), filename: 'c11.jpg' } }])
Property.create!([{ name: 'Loved place', description: 'Presenting opulent, resort-style living in a highly desired location, this astonishing residence is sure to take your breath away.', property_type: PropertyType.last,
