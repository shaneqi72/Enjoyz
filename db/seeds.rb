...
SuburbPostcode.create!([{postcode: 4564, suburb: 'Twin Waters', city: 'Sunshine Coast', state: 'QLD'}, {postcode: 0800, suburb: 'Darwin', city: 'Darwin', state: 'NT'}, {postcode: 3350, suburb: 'Ballarat', city: 'Geelong', state: 'VIC'}])
...
Property.create!([{name: 'Loved place', description: 'Fully stocked', property_type: PropertyType.second, property_location: PropertyLocation.second, bedroom_count: 2, bed_count: 2, bathroom_count: 2, availability: true, start_date: 01-01-2020, end_date: 01-01-2023, nightly_price: 50}, {name: 'Comfort Unit', description: 'Comfort Unit to stay', property_type: PropertyType.third, property_location: PropertyLocation.third, bedroom_count: 3, bed_count: 3, bathroom_count: 2, availability: true, start_date: 01-01-2020, end_date: 01-01-2023, nightly_price: 60},])

Booking.create!([{check_in_date: 03-05-2021, check_out_date: 05-05-2021, adult_count: 2, child_count: 0, traveller: User.first, host: User.second, property: Property.first}])